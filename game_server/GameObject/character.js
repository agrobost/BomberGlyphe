...
var ObserverList = require("../util/observerList");
module.exports = Character;

function Character(user, sio, refGame, gameClassic, positionHtml) {
    "use strict";
    GameObject.call(this, gameClassic.scene);
    this.addObserver(this.scene);
    this.io = sio;
    this.user = user;
    ...
    this.speed = 0.100;
    this.position.x = (30 + 60 * 5);
    this.position.y = (30 + 60 * 3);
...
Character.prototype.stopInterval = function () {
    "use strict";
    clearInterval(this.timer);
    this.deplacement.stopInterval();
};
Character.prototype.toObject = function () {
    "use strict";
    return {
        id: this.user.socket.id,
        health: this.health,
